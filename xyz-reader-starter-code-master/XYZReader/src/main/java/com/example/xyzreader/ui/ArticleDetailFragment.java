    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mScrollView.setCallbacks(new ObservableScrollView.Callbacks() {
            ...
            public void onScrollChanged() {
                ...
                // TODO: comment this out as it will cause a NullPointerException
               // mPhotoContainerView.setTranslationY((int) (mScrollY - mScrollY / PARALLAX_FACTOR));
                updateStatusBar();
            }
        });

        // TODO: remove the mPhotoView and mPhotoContainerView
//        mPhotoView = (ImageView) mRootView.findViewById(R.id.photo);
//        mPhotoContainerView = mRootView.findViewById(R.id.photo_container);

        mStatusBarColorDrawable = new ColorDrawable(0);

        // TODO: comment out the fab button in fragment view
...
//
       ...
       // bodyView.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "Rosario-Regular.ttf"));
        ...
        bindViews(); // this will update the data
        updateStatusBar();
        return mRootView;
    }
...
//                                + "</font>"));
    ...
    public void onAttach(Context context) {
        ...
        {
            // set the callback to pass the bitmap
           mBitMapCallBack =  (SetCallBack) context;
        } else {
            throw new RuntimeException("Require to implement SetTooBarImageCallBack");
        }
    }
